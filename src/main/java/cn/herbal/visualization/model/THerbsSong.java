...
/**
 * 药材药用表
 * @TableName t_herbs_song
 */
@TableName(value ="t_herbs_song")
@Data
public class THerbsSong {
    /**
     * 药材药用部分ID
     */
     ...
     * 阴阳（属性）
     */
    private String yinyangAttributes;

    /**
     * 手足（部位）
     */
    private String handsfeetParts;
    ...
    public boolean equals(Object that) {
        ...
        THerbsSong other = (THerbsSong) that;
        return (this.getHerbsId() == null ? other.getHerbsId() == null : this.getHerbsId().equals(other.getHerbsId()))
            && (this.getHerbsName() == null ? other.getHerbsName() == null : this.getHerbsName().equals(other.getHerbsName()))
            && (this.getMedicinalPart() == null ? other.getMedicinalPart() == null : this.getMedicinalPart().equals(other.getMedicinalPart()))
            && (this.getYinyangAttributes() == null ? other.getYinyangAttributes() == null : this.getYinyangAttributes().equals(other.getYinyangAttributes()))
            && (this.getHandsfeetParts() == null ? other.getHandsfeetParts() == null : this.getHandsfeetParts().equals(other.getHandsfeetParts()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getHerbsName() == null) ? 0 : getHerbsName().hashCode());
        result = prime * result + ((getMedicinalPart() == null) ? 0 : getMedicinalPart().hashCode());
        result = prime * result + ((getYinyangAttributes() == null) ? 0 : getYinyangAttributes().hashCode());
        result = prime * result + ((getHandsfeetParts() == null) ? 0 : getHandsfeetParts().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", herbsName=").append(herbsName);
        sb.append(", medicinalPart=").append(medicinalPart);
        sb.append(", yinyangAttributes=").append(yinyangAttributes);
        sb.append(", handsfeetParts=").append(handsfeetParts);
