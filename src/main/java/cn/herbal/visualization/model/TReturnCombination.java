...
/**
 * 药材—归经表
 * @TableName t_return_combination
 */
@TableName(value ="t_return_combination")
@Data
public class TReturnCombination {
    /**
     * 组合ID
     */
    ...
    public boolean equals(Object that) {
        ...
        TReturnCombination other = (TReturnCombination) that;
        return (this.getCombinationId() == null ? other.getCombinationId() == null : this.getCombinationId().equals(other.getCombinationId()))
