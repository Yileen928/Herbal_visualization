...
public class TComments {
    ...
    public boolean equals(Object that) {
        ...
        TComments other = (TComments) that;
        return (this.getSummaryId() == null ? other.getSummaryId() == null : this.getSummaryId().equals(other.getSummaryId()))
            && (this.getProductsName() == null ? other.getProductsName() == null : this.getProductsName().equals(other.getProductsName()))
            && (this.getCommentsSum() == null ? other.getCommentsSum() == null : this.getCommentsSum().equals(other.getCommentsSum()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getProductsName() == null) ? 0 : getProductsName().hashCode());
        result = prime * result + ((getCommentsSum() == null) ? 0 : getCommentsSum().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", commentsSum=").append(commentsSum);
