<template>
  <div class="YunnanBaiYao">
    <div class="YunnanBaiYao-background">
      <h2 style="margin-top: -3%" @click="goToCompanies">云南白药VS北京同仁堂</h2>
...
// 添加跳转方法
const goToCompanies = () => {
  router.push("/companies"); // 跳转到Companies.vue
};
